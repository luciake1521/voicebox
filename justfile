...
setup-python:
    ...
    # MOSS-TTS-Nano pins torch==2.7.0; keep Voicebox's shared stack and
    # install only its runtime code. ONNX/SentencePiece are in requirements.txt.
    {{ pip }} install --no-deps git+https://github.com/OpenMOSS/MOSS-TTS-Nano.git@8b7bcc9341b3b4ef3a3a58ba1338a7d85ff133eb
